 ...
 */
public class HuanHangCommentListView extends LinearLayout {
    private int itemColor;
    private int itemSelectorColor;
    private OnItemClickListener onItemClickListener;
    private OnItemLongClickListener onItemLongClickListener;
    private List<PengyouquanBean.CommentListBean> mDatas;
    ...
    public void setDatas(List<PengyouquanBean.CommentListBean> datas) {
        if (datas == null) {
            datas = new ArrayList<PengyouquanBean.CommentListBean>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<PengyouquanBean.CommentListBean> getDatas() {
        return mDatas;
    }

    public HuanHangCommentListView(Context context) {
        super(context);
    }

    public HuanHangCommentListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public HuanHangCommentListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.erjibiaoti));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.fengexian));
    ...
    private View getView(final int position) {
        ...
        final PengyouquanBean.CommentListBean bean = mDatas.get(position);
        String name = bean.getCommentUser();
        Long id = bean.getId();
        String toReplyName = "";
        if (bean.getByCommentUser() != null) {
            toReplyName = bean.getByCommentUser();
        }
