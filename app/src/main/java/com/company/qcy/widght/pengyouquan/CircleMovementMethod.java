...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.fengexian;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = I7colorsApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = I7colorsApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
