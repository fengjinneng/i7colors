...
public class WodeFanganListAdapter extends BaseQuickAdapter<FangAnBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, FangAnBean item) {
        ...
        FangAnBean.ZhujiDiyBean zhujiDiyBean = item.getZhujiDiy();
...
//            shenfen.setText(zhujiDiyBean.getPublishType());
//            if (StringUtils.equals("个人发布", zhujiDiyBean.getPublishType())) {
//                shenfen.setBackground(mContext.getResources().getDrawable(R.mipmap.gerenfabu));
//            } else if (StringUtils.equals("企业发布", zhujiDiyBean.getPublishType())) {
...
//        }
        ...
        if (StringUtils.isEmpty(zhujiDiyBean.getEndTimeStamp())) {
            qian.setText("");
            qianUnit.setText("");
            hou.setText("");
            houUnit.setText("");
