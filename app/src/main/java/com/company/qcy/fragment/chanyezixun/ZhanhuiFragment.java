...
public class ZhanhuiFragment extends Fragment {
    ...
    public ZhanhuiFragment() {
        // Required empty public constructor
    }

    public static ZhanhuiFragment newInstance(String param1) {
        ZhanhuiFragment fragment = new ZhanhuiFragment();
