...
public class HangyezixunFragment extends Fragment {
    ...
    public HangyezixunFragment() {
        // Required empty public constructor
    }

    public static HangyezixunFragment newInstance(String param1) {
        HangyezixunFragment fragment = new HangyezixunFragment();
                        ...
                        try {
                            if (response.code() == 200) {
                                ...
                                if (StringUtils.equals(jsonObject.getString("code"), getResources().getString(R.string.success))) {
                                    ...
                                    LogUtils.v("INFORMATIONLIST", data);
