...
public class GuanzhuFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onRec(MessageBean messageBean) {
        ...
        switch (messageBean.getCode()) {
            //删除评论成功
            case MessageBean.GuanzhuCode.DELETEPINGLUNCHENGGONG:
                ...
                break;
            //发布朋友圈成功
            case MessageBean.GuanzhuCode.FABUPENGYOUQUANCHENGGONG:
            ...
            case MessageBean.Code.GUANZHUCHENGGONG:
                ...
                break;
            //朋友圈需要刷新
            case MessageBean.GuanzhuCode.PENGYOUQUANNEEDREFLUSH:
                swipeRefreshLayout.setRefreshing(true);
                refreshListener.onRefresh();
                break;

            //朋友圈需要刷新
            case MessageBean.GuanzhuCode.XIANGQINGYEDIANZANCHENGGONG:
                swipeRefreshLayout.setRefreshing(true);
                refreshListener.onRefresh();
                break;
            //微信登陆成功
    ...
    private void addData() {
        ...
        pageNo++;
        GetRequest<String> request = OkGo.<String>get(ServerInfo.SERVER + InterfaceInfo.QUERYDYECOMMUNITYLISTGUANZHU)
                .tag(this)
                .params("sign", SPUtils.getInstance().getString("sign"))
        ...
        StringCallback stringCallback = new StringCallback() {
            ...
            public void onSuccess(Response<String> response) {
                ...
                LogUtils.v("QUERYDYECOMMUNITYLISTGUANZHU", response.body());
