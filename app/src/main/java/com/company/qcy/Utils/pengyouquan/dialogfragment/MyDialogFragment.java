...
public class MyDialogFragment extends DialogFragment {
    ...
    private PinglunHouCallBack pinglunHouCallBack = null;


    public void setPinglunHouCallBack(PinglunHouCallBack pinglunHouCallBack) {
        this.pinglunHouCallBack = pinglunHouCallBack;
    }
...
//                EventBus.getDefault().post(new MessageBean(MessageBean.Code.ASAAAAAAAAAA,String.valueOf(id),position));
                ...
                InputMethodManager imm = (InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
                pinglunHouCallBack.save(inputComment.getText().toString(), id, position);
