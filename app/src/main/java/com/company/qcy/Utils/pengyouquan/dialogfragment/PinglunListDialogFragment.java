...
public class PinglunListDialogFragment extends DialogFragment {

    private Long id;
    private Long parentId;
    private int position;

    private PinglunListCallBack pinglunListCallBack = null;


    public void setPinglunHouCallBack(PinglunListCallBack pinglunListCallBack) {
        this.pinglunListCallBack = pinglunListCallBack;
    }
    ...
    public void setPosition(Long parentId) {
...
//                KeyboardUtils.hideSoftInput(getActivity());
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InputMethodManager imm = (InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
                pinglunListCallBack.save(inputComment.getText().toString(),id,parentId,position);
