package com.company.qcy.Utils.yanzhengma;
...
public class SeparatedEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderColor = ta.getColor(R.styleable.SeparatedEditText_borderColor, ContextCompat.getColor(getContext(), R.color.shenhui));
        blockColor = ta.getColor(R.styleable.SeparatedEditText_blockColor, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        textColor = ta.getColor(R.styleable.SeparatedEditText_textColor, ContextCompat.getColor(getContext(), R.color.shenhui));
        cursorColor = ta.getColor(R.styleable.SeparatedEditText_cursorColor, ContextCompat.getColor(getContext(), R.color.shenhui));
