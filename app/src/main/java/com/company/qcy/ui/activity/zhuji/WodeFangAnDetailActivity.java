...
public class WodeFangAnDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private WodeFangAnDetailFangAnAdapter adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wode_fang_an_detail);
    ...
    private void initView() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.activity_wode_fangan_detail_recyclerview);
        mToolbarTitle.setText("我的助剂定制方案详情");

        datas = new ArrayList<>();
        adapter = new WodeFangAnDetailFangAnAdapter(R.layout.item_zhuji_fangan,datas);
    ...
    private void addData() {
        ...
        GetRequest<String> request = OkGo.<String>get(ServerInfo.SERVER + InterfaceInfo.WODEJIEJUEFANGANDETAIL)
                .tag(this)
                .params(params);
        ...
        DialogStringCallback stringCallback = new DialogStringCallback(this) {
            ...
            public void onSuccess(Response<String> response) {
                LogUtils.v("WODEJIEJUEFANGANDETAIL", response.body());
                ...
                try {
                    if (response.code() == 200) {
                        ...
                        if (StringUtils.equals(jsonObject.getString("code"), getResources().getString(R.string.success))) {
                            ...
                            FangAnBean fangAnBean = data.toJavaObject(FangAnBean.class);
                            if (!ObjectUtils.isEmpty(fangAnBean)) {
                                setData(fangAnBean);
                            }
                        ...
                        if (StringUtils.equals(jsonObject.getString("code"), getResources().getString(R.string.qianmingshixiao))) {
                            SignAndTokenUtil.getSign(WodeFangAnDetailActivity.this, request, this);
                            return;
                        }
    ...
    private void setData(FangAnBean fangAnBean) {

        addHeadView(fangAnBean);

        datas.add(fangAnBean);
    ...
    private void addHeadView(FangAnBean fangAnBean) {

        FangAnBean.ZhujiDiyBean bean = fangAnBean.getZhujiDiy();
        ...
        TextView yiwancheng  = view.findViewById(R.id.activity_zhuji_detail_yiwancheng);
        ...
        meiyueyongliang.setText(StringUtils.isEmpty(bean.getUseNumStr()) ? "暂无" : bean.getUseNumStr() );
