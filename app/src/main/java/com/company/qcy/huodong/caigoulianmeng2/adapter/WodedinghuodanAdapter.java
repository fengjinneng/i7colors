...
public class WodedinghuodanAdapter extends BaseQuickAdapter<HuodanBean, BaseViewHolder> {



    public WodedinghuodanAdapter(int layoutResId, @Nullable List<HuodanBean> data) {
