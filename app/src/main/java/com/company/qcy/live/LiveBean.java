...
public class LiveBean {
    ...
    public String getLoginUserIsBuy() {
        return loginUserIsBuy;
    }

    public void setLoginUserIsBuy(String loginUserIsBuy) {
        this.loginUserIsBuy = loginUserIsBuy;
    }
    ...
    public String getIsDefaultBanner() {
